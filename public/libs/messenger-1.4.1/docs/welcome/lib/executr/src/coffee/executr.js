...
(function() {
  ...
  Editor = (function() {
    ...
    Editor.prototype.addListeners = function() {
      return this.$el.on('executrSwitchType', (function(_this) {
    ...
    Editor.prototype.addRunButton = function() {
      ...
      return this.$runButton.click((function(_this) {
        return function() {
    ...
    Editor.prototype.buildEditor = function() {
      var code, mirrorOpts, ref, ref1, type;
      this.$editorCont = $('<div>');
      ...
      if (typeof this.opts.type === 'function') {
        ...
        type = (ref = (ref1 = this.opts.type) != null ? ref1 : this.$el.attr('data-type')) != null ? ref : this.opts.defaultType;
      }
    ...
    Editor.prototype.run = function(type, opts, code) {
      var from, func, key, ref, runner, to;
      runner = runners[type];
      if (runner == null) {
        for (key in converters) {
          func = converters[key];
          ref = key.split(':'), from = ref[0], to = ref[1];
